	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<br/>
				<!-- 添加用户 -->
				<form name="myform" action="${pageContext.request.contextPath}/submitweiguidengji" onsubmit="" method="post">	
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						...
						<br/><br/>
						<label>车辆状态设置为:<span style="color: red;">禁用</span></label>
					</div>					
					...
					<button type="submit" class="btn btn-primary" style="float: left; margin-left: 30px">违规登记</button>
