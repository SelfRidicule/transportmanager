		...
		<div class="row">
			<div class="col-lg-12">
				...
				<br/>
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						<label>电话 : <span style="font-weight:normal;">${singleyundanshenhe.dianhua }</span></label>
					</div>					
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>实收运费: <span style="font-weight:normal;">${singleyundanshenhe.shishouyunfei}</span></label>
					</div>						
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						<label>审核状态: <span style="font-weight:normal; color: red;">${singleyundanshenhe.yundanzhuangtai}</span></label>
					</div>		
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						<label>操作员: <span style="font-weight:normal;">${caoZuoYuanName}</span></label>
					</div>		
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>操作日期: <span style="font-weight:normal;">${singleyundanshenhe.caozuoriqi}</span></label>
					</div>	
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						<label>实发吨位: <span style="font-weight:normal;">${singleyundanshenhe.shifadunwei}</span></label>
					</div>					
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>实收吨位: <span style="font-weight:normal;">${singleyundanshenhe.shishoudunwei}</span></label>
					</div>					
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						<label>里程: <span style="font-weight:normal;">${singleyundanshenhe.licheng}</span></label>
					</div>					
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>代垫费: <span style="font-weight:normal;">${singleyundanshenhe.daidianfei}</span></label>
					</div>		
					...
					<div class="form-group" style="float: left; margin-left: 30px">
						<label>费用描述: <span style="font-weight:normal;">${singleyundanshenhe.feiyongmiaoshu}</span></label>
					</div>	
					...
					<div class="form-group" style="float: left; margin-left: 30px">
						<label>运单审核备注: <span style="font-weight:normal;">${singleyundanshenhe.beizhu}</span></label>
					</div>					
