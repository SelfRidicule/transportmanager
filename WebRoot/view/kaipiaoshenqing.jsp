...
<head>
	...
	<script type="text/javascript">
		...
		function shenqing(){
			document.usersform.action="${pageContext.request.contextPath}"+"/jumpUpdateKaiPiaoShenQing";
		}
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default" style="background-color: #f1f4f7;">
					...
					<!-- 查询 修改 表单 -->
					<form name="usersform" action="${pageContext.request.contextPath}/vagueSearchKaiPiaoShenQing" method="post" onsubmit="" >
						<div style="">
							...
							<select class="form-control" name="kaipiaoshenqing" style="width: 200px; margin-left: 10px; margin-top: 15px; float: left;">
						        <option value="">开票申请</option>
					...
					<div class="panel-body">
						...
						<button type="submit" onclick="shenqing()" class="btn btn-warning" style="float: left ; margin-top: 10px;">开票申请</button>
				        
						<div style="float: left ; margin-top: 10px; margin-left: 10px;color: red;line-height:30px;font-size: 16px">${yingshoukuanerr}</div>
						<table data-toggle="table" data-url="${pageContext.request.contextPath}/kaiPiaoShenQingJson"  data-id-field="id"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc" data-click-to-select="true">
						    <thead>
						    <tr>
						        ...
						        <th data-field="kaipiaoshenqing" data-sortable="true">开票申请</th>
