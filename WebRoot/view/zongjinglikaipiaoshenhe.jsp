...
<head>
	...
	<script type="text/javascript">
		...
		function shenhe(){
			document.usersform.action="${pageContext.request.contextPath}"+"/jumpUpdateZongJingLiKaiPiaoShenHe";
		}
		
		function shenHeYesAll(){
			document.usersform.action="${pageContext.request.contextPath}"+"/kaiPiaoShenHeZongJingLiYesAll";
		}

		function shenHeNoAll(){
			document.usersform.action="${pageContext.request.contextPath}"+"/kaiPiaoShenHeZongJingLiNoAll";
		}
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default" style="background-color: #f1f4f7;">
					...
					<!-- 查询 修改 表单 -->
					<form name="usersform" action="${pageContext.request.contextPath}/vagueSearchZongJingLiKaiPiaoShenHe" method="post" onsubmit="" >
						<div style="">
							...
							<select class="form-control" name="zongjinglikaipiaoshenhe" style="width: 200px; margin-left: 10px; margin-top: 15px; float: left;">
						        <option value="">开票审核</option>
					...
					<div class="panel-body">
						...
						<table data-toggle="table" data-url="${pageContext.request.contextPath}/zongJingLiKaiPiaoShenHeJson"  data-id-field="id"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc" data-click-to-select="true">
						    <thead>
						    <tr>
