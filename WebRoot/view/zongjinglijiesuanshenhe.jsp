...
<head>
	...
	<script type="text/javascript">
		...
		function shenhe(){
			document.usersform.action="${pageContext.request.contextPath}"+"/jumpUpdateZongJingLiJieSuanShenHe";
		} 

		function shenHeYesAll(){
			document.usersform.action="${pageContext.request.contextPath}"+"/jieSuanShenHeZongJingLiYesAll";
		}

		function shenHeNoAll(){
			document.usersform.action="${pageContext.request.contextPath}"+"/jieSuanShenHeZongJingLiNoAll";
		}
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default" style="background-color: #f1f4f7;">
					...
					<!-- 查询 修改 表单 -->
					<form name="usersform" action="${pageContext.request.contextPath}/vagueSearchZongJingLiJieSuanShenHe" method="post" onsubmit="" >
						<div style="">
							...
							<select class="form-control" name="zongjinglijiesuanshenhe" style="width: 200px; margin-left: 10px; margin-top: 15px; float: left;">
					...
					<div class="panel-body">
						...
						<table data-toggle="table" data-url="${pageContext.request.contextPath}/zongJingLiJieSuanShenHeJson"  data-id-field="id"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc" data-click-to-select="true">
						    <thead>
						    <tr>
