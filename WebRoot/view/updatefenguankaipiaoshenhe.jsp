		...
		<div class="row">
			<div class="col-lg-12">
				...
				<br/>
					...
					<a href="${pageContext.request.contextPath}/jumpFenGuanKaiPiaoShenHe"><button type="button"  class="btn btn-success" style="float: left; margin-left: 30px">返回</button></a>
					
					<a href="${pageContext.request.contextPath}/updateFenGuanKaiPiaoShenHe?flag=审核通过&id=${singleyingshoukuan.id}"><button type="button"  class="btn btn-primary" style="float: left; margin-left: 30px">审核通过</button></a>
					<a href="${pageContext.request.contextPath}/updateFenGuanKaiPiaoShenHe?flag=未通过&id=${singleyingshoukuan.id}"><button type="button"  class="btn btn-danger" style="float: left; margin-left: 30px">未通过</button></a>
				</form>	
				<!-- end -->
