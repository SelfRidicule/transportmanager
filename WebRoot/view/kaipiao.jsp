...
<head>
	...
	<script type="text/javascript">
		...
		function zaicikaipiao(){
			document.usersform.action="${pageContext.request.contextPath}"+"/jumpSuperYingShouKuanInKaiPiao";
		}
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default" style="background-color: #f1f4f7;">
					...
					<!-- 查询 修改 表单 -->
					<form name="usersform" action="${pageContext.request.contextPath}/vagueSearchYingShouKuanKaiPiao" method="post" onsubmit="" >
						<div style="">
					...
					<div class="panel-body">
						...
						<c:forEach items="${usersquanxianlist}" var="usersquanxian">
							...
							<c:if test="${usersquanxian.quanxianbumen == '开票' && usersquanxian.weihu == '1' }">
								<button type="submit" onclick="zaicikaipiao()" class="btn btn-danger" style="float: left ; margin-top: 10px; margin-left: 10px">再次开票</button>
							</c:if>
						</c:forEach>	
						
						<div style="float: left ; margin-top: 10px; margin-left: 10px;color: red;line-height:30px;font-size: 16px">${yingshoukuanerr}</div>
						<table data-toggle="table" data-url="${pageContext.request.contextPath}/yingShouKuanKaiPiaoJson"  data-id-field="id"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc" data-click-to-select="true">
						    <thead>
						    <tr>
