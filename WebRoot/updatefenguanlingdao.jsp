	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<form name="myform" action="${pageContext.request.contextPath}/updateFenGuanLingDao" onsubmit="" method="post" enctype="multipart/form-data">	
					
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						<label>车牌号<span style="color: red;">*&nbsp;</span></label>
						<input name="chepaihao" class="form-control" value="${singlefenguanlingdao.chepaihao}"  readonly="readonly"/>
					</div>	
					...
					<div class="form-group" style="width: 70%; float: left; margin-left: 30px">
						...
						<textarea class="form-control" rows="5" name="fenguanlingdaoyijian" required="required">${singlefenguanlingdao.fenguanlingdaoyijian}</textarea>
					</div>			
