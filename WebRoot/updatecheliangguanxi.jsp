	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div id="dialog" class="animated" style="width: 800px; height: 310px; margin-top: -230px;margin-left: -300px">
					<div id="myselect" style="margin-top: 40px; margin-left:24px ; width: 750px; height: 300px;">
						<select multiple="multiple" size="10" name="duallistbox_demo1[]">
							 <c:forEach items="${guachearr}" var="selectedguache">
									<option value="${selectedguache}" selected="selected">${selectedguache}</option>
					         </c:forEach>	
						
							 <c:forEach items="${guachelist}" var="selectguache">
									<option value="${selectguache.chepaihao}">${selectguache.chepaihao}</option>
					         </c:forEach>
					    </select>
				...
				<form name="myform" action="${pageContext.request.contextPath}/submitUpdateCheLiangGuanXi" onsubmit="return panduan()" method="post">	
					
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						<label>牵引车 </label>
						<input name="qianyinche"  class="form-control" value="${singlecheliangguanxi.qianyinche}" readonly="readonly" />
					</div>					
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						...
						<input name="guache"  class="form-control" value="${singlecheliangguanxi.guache}" placeholder="请选择挂车" readonly="readonly" />
					</div>	
					...
					<div class="form-group" style="width: 80%; float: left; margin-left: 30px">
						<label>备注</label>
						<textarea class="form-control" rows="5" name="beizhu" >${singlecheliangguanxi.beizhu}</textarea>
					</div>	
