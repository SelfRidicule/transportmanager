	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">修改保险处理  车牌号:<span style="color: red">${singlebaoxianchuli.chepaihao}</span></li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<br/>
				<!-- 添加保险 -->
				<form name="myform" action="${pageContext.request.contextPath}/submitUpdateBaoXianChuLi" onsubmit="" method="post">	
					...
					<button type="submit" class="btn btn-primary" style="float: left; margin-left: 30px">修改处理</button>
