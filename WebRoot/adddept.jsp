	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<br/>
				<!-- 添加用户 -->
				<form name="myform" action="${pageContext.request.contextPath}/addDept" onsubmit="return validate()" method="post">	
				
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						<label>部门名称 <span  style="color: red;">*</span> </label>
						<input name="deptname" class="form-control" placeholder="请输入部门名称" required="required"/>
					</div>					
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>部门领导<span  style="color: red;">*</span></label>
						<input name="leader" class="form-control" placeholder="请输入部门领导" required="required"/>
					</div>						
					...
					<button type="submit" class="btn btn-primary" style="float: left; margin-left: 30px">添加部门</button>
