	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<form name="myform" action="${pageContext.request.contextPath}/updateTouRuShenHe" onsubmit="" method="post">	
					
					<div class="form-group" style="width: 70%; float: left; margin-left: 30px">
						<label>新车符合性初审及购车交代<span style="color: red;">*</span></label>
						<textarea class="form-control" rows="5" name="shenhejiaodai" required="required">${singletourushenhe.shenhejiaodai }</textarea>
					</div>					
					...
					<div class="form-group" style="width: 20%; float: left; margin-left: 30px">
						...
						<input id="riqi1" name="shenpishijian"  class="form-control" value="${fn:substring(singletourushenhe.shenpishijian, 0, 10)}" placeholder="请输入运管审批时间" required="required"/>
					</div>					
					
					<div class="form-group" style="width: 20%; float: left; margin-left: 30px">
						<label>拟安装终端型号<span style="color: red;">*</span></label>
						<input class="form-control"  name="zhongduanxinghao" value="${singletourushenhe.zhongduanxinghao}" placeholder="请输入拟安装终端型号" required="required">
					</div>	
					
					<div class="form-group" style="width: 20%; float: left; margin-left: 30px">
						<label>责任人<span style="color: red;">*</span></label>
						<input class="form-control"  name="zerenren" value="${singletourushenhe.zerenren}" placeholder="请输入责任人" required="required">
					</div>		
