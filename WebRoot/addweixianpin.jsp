	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<form name="myform" action="${pageContext.request.contextPath}/addWeiXianPin" onsubmit="" method="post" enctype="multipart/form-data">	
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						...
						<input name="huowumingcheng" class="form-control" placeholder="请输入货物名称" required="required"/>
					</div>		
								
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>安全卡<span style="color: red;  padding-top: 10px">*</span></label>
						<input type="file" name="anquanka" required="required">
					</div>		
