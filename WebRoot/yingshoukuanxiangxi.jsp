			...
			<div class="col-lg-12">
				...
				<br/>
					...
					<div class="form-group" style="width: 60%; float: left; margin-left: 30px">
						<label>备注 : <span style="font-weight:normal;">${singleyingshoukuan.beizhu }</span></label>
					</div>	
					...
					<a href="${pageContext.request.contextPath}/jumpYingShouKuan"><button type="button"  class="btn btn-success" style="float: left; margin-left: 30px">返回</button></a>
