	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<br/>
				<!-- 添加车辆 -->
				<form id="myform" name="myform" action="${pageContext.request.contextPath}/#" onsubmit="" method="post">	
					...
					<table border="" cellspacing="" cellpadding="" width="90%" style="border-collapse: collapse; border-color: black; margin-left: 5%">
						<tr>
						  ...
						  <td width="25%" align="center"  >${singlekaipiao.kehudanwei}</td>
						...
						<tr>
						  ...
						  <td width="25%" align="center"  >${singlekaipiao.shibiehao}</td>
				      </tr>
						<tr>
						  <td width="25%" height="40" align="center"  >地址</td>
						  <td width="25%" align="center"  >${singlekaipiao.dizhi}</td>
						  <td width="25%" align="center"  >电话</td>
						  <td width="25%" align="center"  >${singlekaipiao.dianhua}</td>
				      </tr>
					   <tr>
						  <td width="25%" height="40" align="center"  >开户行</td>
						  <td width="25%" align="center"  >${singlekaipiao.kaihuhang}</td>
						  <td width="25%" align="center"  >账号</td>
						  <td width="25%" align="center"  >${singlekaipiao.zhanghao}</td>
				      </tr>
					</table>
			        ...
			        <table border="" cellspacing="" cellpadding="" width="90%" style="border-collapse: collapse; border-color: black;  margin-left: 5%;">
		         	 ...
		         	 <c:forEach items="${kaiPiaoXiangXiModelList}" var="kaiPiaoXiangXiModel">
			         	 <tr>
						   <td height="35" align="center"  >${kaiPiaoXiangXiModel.xuhao}</td>
						   <td height="35" align="center"  >${kaiPiaoXiangXiModel.chengyunren}</td>
						   <td height="35" align="center"  >${kaiPiaoXiangXiModel.kaipiaojine}</td>
						   <td height="35" align="center"  >${kaiPiaoXiangXiModel.shuijin}</td>
						   <td height="35" align="center"  >${kaiPiaoXiangXiModel.guanlifei}</td>
						   <td height="35" align="center"  >${kaiPiaoXiangXiModel.shifuyunfei}</td>
						   <td height="35" align="center"  >${kaiPiaoXiangXiModel.daidianfei}</td>
						   <td height="35" align="center"  >${kaiPiaoXiangXiModel.zuchefei}</td>
						   <td height="35" align="center"  >${kaiPiaoXiangXiModel.yewufei}</td>
						   <td height="35" align="center"  >${kaiPiaoXiangXiModel.beizhu}</td>
			         	 </tr>
			          </c:forEach>
					...
					<br/>
					<div align="center" style=" width: 100% ;" >制表人：${singlekaipiao.caozuoyuan} &nbsp 
												分管经理：&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 
												 总经理：
					</div>
					<br/>
				</form>	
					<a href="${pageContext.request.contextPath}/kaipiao.jsp"> <button type="button"  class="btn btn-info" style="float: left; margin-left: 5%">返回</button></a>
				<!-- end -->
