	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">保险出单、材料扫描、电子档案建立、劳动防护用品配备</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<form name="myform" action="${pageContext.request.contextPath}/addBaoXianChuDan" onsubmit="" method="post" enctype="multipart/form-data">	
