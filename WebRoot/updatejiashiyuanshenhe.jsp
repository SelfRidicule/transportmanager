		...
		<div class="row">
			<div class="col-lg-12">
				...
				<br/>
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						<label>出生日期 : <span style="font-weight:normal;">${singlejiashiyuanshenhe.chushengriqi}</span></label>
					</div>					
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						<label>初次领证日期 : <span style="font-weight:normal;">${singlejiashiyuanshenhe.chucilingzhengriqi}</span></label>
					</div>					
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>驾驶证年审日期 : <span style="font-weight:normal;">${singlejiashiyuanshenhe.jiashizhengnianshenriqi}</span></label>
					</div>		
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>从业资格继续教育时间: <span style="font-weight:normal;">${singlejiashiyuanshenhe.congyezigejixujiaoyushijian}</span></label>
					</div>		
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						<label>从业资格诚信考核时间: <span style="font-weight:normal;">${singlejiashiyuanshenhe.congyezigechengxinkaoheshijian}</span></label>
					</div>					
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>证件有效日期: <span style="font-weight:normal;">${singlejiashiyuanshenhe.zhengjianyouxiaoriqi}</span></label>
					</div>		
					...
					<a href="${pageContext.request.contextPath}/submitUpdateJiaShiYuanShenHe?shenhezhuangtai=审核通过"> <button type="button"  class="btn btn-info" style="float: left; margin-left: 10px">审核通过</button></a>
					<a href="${pageContext.request.contextPath}/submitUpdateJiaShiYuanShenHe?shenhezhuangtai=审核失败"> <button type="button"  class="btn btn-danger" style="float: left; margin-left: 10px">审核失败</button></a>
