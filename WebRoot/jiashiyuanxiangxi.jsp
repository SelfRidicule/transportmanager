		...
		<div class="row">
			<div class="col-lg-12">
				...
				<br/>
					...
					<div class="form-group" style="width: 20%; float: left; margin-left: 30px">
						<label>性别 : <span style="font-weight:normal;">${singlejiashiyuanshenhe.xingbie}</span></label>
					</div>	
					...
					<div class="form-group" style="width: 20%; float: left; margin-left: 30px">
						<label>身份证号/驾驶证号 : <span style="font-weight:normal;">${singlejiashiyuanshenhe.shenfenzhenghao}</span></label>
					</div>			
								
					<div class="form-group" style="width: 20%; float: left; margin-left: 30px">
						<label>驾驶证档案编号 : <span style="font-weight:normal;">${singlejiashiyuanshenhe.jiashizhengbianhao}</span></label>
					</div>				
					...
					<div class="form-group" style="width: 20%; float: left; margin-left: 30px">
						<label>驾驶证年审到期日期 : <span style="font-weight:normal;">${fn:substring(singlejiashiyuanshenhe.jiashizhengnianshenriqi, 0, 10)}</span></label>
					</div>					
					
					<div class="form-group" style="width: 20%; float: left; margin-left: 30px">
						<label>驾驶证有效日期至: <span style="font-weight:normal;">${fn:substring(singlejiashiyuanshenhe.zhengjianyouxiaoriqi, 0, 10)}</span></label>
					</div>	
					...
					<div class="form-group" style="width: 20%; float: left; margin-left: 30px">
						<label>从业资格证有效期至: <span style="font-weight:normal;">${fn:substring(singlejiashiyuanshenhe.congyezigeriqi, 0, 10)}</span></label>
					</div>
					
					<div class="form-group" style="width: 20%; float: left; margin-left: 30px">
						<label>发证机关: <span style="font-weight:normal;">${singlejiashiyuanshenhe.fazhengjiguan}</span></label>
					</div>	
					...
					<div class="form-group" style="width: 20%; float: left; margin-left: 30px">
						<label>继续教育有效期起: <span style="font-weight:normal;">${fn:substring(singlejiashiyuanshenhe.congyezigejixujiaoyushijian, 0, 10)}</span></label>
					</div>
					
					<div class="form-group" style="width: 20%; float: left; margin-left: 30px">
						<label>继续教育有效期止: <span style="font-weight:normal;">${fn:substring(singlejiashiyuanshenhe.congyezigejixujiaoyushijianzhi, 0, 10)}</span></label>
					</div>
					
					<div class="form-group" style="width: 20%; float: left; margin-left: 30px">
						<label>诚信考核到期日期: <span style="font-weight:normal;">${fn:substring(singlejiashiyuanshenhe.congyezigechengxinkaoheshijian, 0, 10)}</span></label>
					</div>
					...
					<a href="${pageContext.request.contextPath}/jumpJiaShiYuan"> <button type="button"  class="btn btn-success" style="float: left; margin-left: 30px">返回</button></a>
