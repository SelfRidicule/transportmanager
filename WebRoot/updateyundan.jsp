	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<br/>
				<!-- 添加 -->
				<form name="myform" action="${pageContext.request.contextPath}/submitUpdateYunDan" onsubmit="return test()" method="post">	
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>车牌号 </label>
						<select id="basic2" name="chepaihao" class="show-tick form-control" disabled="disabled">
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						<label>运费</label>
						<div style="clear: both;"></div>
						<input name="baochoujine" class="form-control" value="${singleyundan.baochoujine}" placeholder="请输入运费金额"  disabled="disabled" style="width: 48%; float: left; "/>
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>实收运费</label>
						<div style="clear: both;"></div>
						<input name="shishouyunfei" class="form-control" value="${singleyundan.shishouyunfei}" placeholder="请输入实收运费"  disabled="disabled" style="width: 48%; float: left; "/>
