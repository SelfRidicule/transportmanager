	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<form name="myform" action="${pageContext.request.contextPath}/addZeRenRen" onsubmit="" method="post" enctype="multipart/form-data">	
					...
					<!-- <div class="form-group" style="width: 70%; float: left; margin-left: 30px">
						<label>责任人意见</label>
						<textarea class="form-control" rows="5" name="zerenrenyijian"></textarea>
					</div>	 -->		
