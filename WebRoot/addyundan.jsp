...
<head>
	...
	<script type="text/javascript">
		...
		// 定义变量
		var dingdanhaoBoolean = 0 ;
		var dianhuaBoolean = 0 ;
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<br/>
				<!-- 添加 -->
				<form name="myform" action="${pageContext.request.contextPath}/addYunDan" onsubmit="return test()" method="post">	
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						...
						<input name="dingdanhao" class="form-control" onblur="existdingdanhao()" placeholder="请输入订单号" required="required"/>
					</div>					
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						...
						<input id="riqi1" name="yunshushijian"  class="form-control" placeholder="请输入运输时间" required="required"/>
					</div>	
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						...
						<input name="qidian" class="form-control" placeholder="请输入起点" required="required"/>
					</div>					
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>终点<span style="color: red;  padding-top: 10px">*</span></label>
						<input name="zhongdian" class="form-control" placeholder="请输入终点" required="required"/>
					</div>		
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						<label>运费</label>
						<div style="clear: both;"></div>
						<input name="baochoujine" class="form-control" placeholder="请输入运费"  style="width: 48%; float: left; "/>
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>实收运费</label>
						<div style="clear: both;"></div>
						<input name="shishouyunfei" class="form-control" placeholder="请输入实收运费"  style="width: 48%; float: left; " />
						<select class="form-control" name="shishouleixing" style="width: 48%; float: left; margin-left: 10px;">
								<option value="元每车">元每车</option>
								<option value="元每吨">元每吨</option>
						</select>
					</div>		
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						...
						<input name="yujidunwei" class="form-control" placeholder="请输入预计吨位" required="required"/>
					</div>		
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>安全卡</label>
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						...
						<input name="dizhi" class="form-control" placeholder="请输入地址" required="required"/>
					</div>	
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>货物名称<span style="color: red;  padding-top: 10px">*</span></label>
						<input name="huowumingcheng" class="form-control" value="" required="required"/>
					</div>		
					...
					<div class="form-group" style="width: 70%; float: left; margin-left: 30px">
						<label>运单备注</label>
						<textarea class="form-control" rows="3" name="yundanbeizhu"></textarea>
					</div>	
