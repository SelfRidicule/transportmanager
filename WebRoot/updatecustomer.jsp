	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<br/>
				<!-- 添加用户 -->
				<form name="myform" action="${pageContext.request.contextPath}/submitUpdateCustomer" onsubmit="" method="post">	
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						...
						<input name="customername" value="${singlecustomer.customername}" class="form-control" placeholder="请输入客户全称" required="required"/>
					</div>					
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						...
						<input name="shortname" value="${singlecustomer.shortname}" class="form-control" placeholder="请输入客户单位简称" required="required"/>
					</div>						
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						...
						<input name="contactaddress" value="${singlecustomer.contactaddress}" class="form-control" placeholder="请输入联系地址" required="required"/>
					</div>		
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>客户单位<span style="color: red;  padding-top: 10px">*</span></label>
						<input name="kehudanwei" class="form-control" value="${singlecustomer.kehudanwei}" placeholder="请输入客户单位" required="required" readonly="readonly"/>
					</div>		
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						...
						<input name="identifynumber" value="${singlecustomer.identifynumber}" class="form-control" placeholder="请输入纳税人识别号" required="required"/>
					</div>					
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>开户行<span style="color: red;  padding-top: 10px">*</span></label>
						<input name="bankaccount" value="${singlecustomer.bankaccount}" class="form-control" placeholder="请输入开户行" required="required"/>
					</div>	
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						...
						<input name="account" value="${singlecustomer.account}" class="form-control" placeholder="请输入帐号" required="required"/>
					</div>					
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>联系人<span style="color: red;  padding-top: 10px">*</span></label>
						<input name="contactperson" value="${singlecustomer.contactperson}" class="form-control" placeholder="请输入联系人" required="required"/>
					</div>	
					...
					<div class="form-group" style="width: 30%; float: left; margin-left: 30px">
						...
						<input name="contactnumber" value="${singlecustomer.contactnumber}" class="form-control" placeholder="请输入联系电话" required="required"/>
					</div>					
					<div class="form-group" style="width: 30%; float: left; margin-left: 10%">
						<label>手机号码<span style="color: red;  padding-top: 10px">*&nbsp;</span><span id="dianhuatishi" style="display: none; color: red;">格式不规范</span></label>
						<input name="phonenumber" value="${singlecustomer.phonenumber}" class="form-control"  placeholder="请输入手机号码" required="required"/>
					</div>		
					...
					<div class="form-group" style="width: 80%; float: left; margin-left: 30px">
						...
						<textarea class="form-control" rows="5" name="comment">${singlecustomer.comment}</textarea>
					</div>	
