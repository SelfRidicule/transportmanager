...
<head>
	...
	<script type="text/javascript">
		...
		function myDelete(){
			document.usersform.action="${pageContext.request.contextPath}"+"/kaiPiaoDelete";
		}
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default" style="background-color: #f1f4f7;">
					...
					<!-- 查询 修改 表单 -->
					<form name="usersform" action="${pageContext.request.contextPath}/vagueSearchKaiPiao" method="post" onsubmit="">
						<div style="">
							...
							<input class="form-control" placeholder="承运人" name="chengyunren"  value="" style="width: 200px; margin-left: 10px; margin-top: 15px; float: left;">
					...
					<button type="submit" onclick="myDelete()" class="btn btn-danger" style="float: left ; margin-top: 30px ; margin-left: 20px;">删除</button>
					<!-- 水平线 -->
					<div class="panel-body">
						<table data-toggle="table" data-url="${pageContext.request.contextPath}/kaiPiaoJson"  data-id-field="id"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc" data-click-to-select="true">
						    <thead>
						    <tr>
						   		<th data-field="state" data-checkbox="true" >checkbox</th>
						        <th data-field="kehudanwei" data-sortable="true">客户单位</th>
						        <th data-field="chengyunren" data-sortable="true">承运人</th>
						        <th data-field="huowumingcheng" data-sortable="true">货物名称</th>
						        <th data-field="kaipiaoshijian" data-sortable="true">开票时间</th>
